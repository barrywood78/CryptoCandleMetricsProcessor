            ...
            using (var connection = new SqliteConnection(connectionString))
            {
                ...
                foreach (var group in groupedCandles)
                {
                    ...
                    var indicators = new Dictionary<string, Action<SqliteConnection, SqliteTransaction, string, string, string, List<Quote>, Dictionary<string, int>>>
                    {
                        ...
                        {"CyclicalPatterns", (conn, trans, table, prod, gran, c, p) => CyclicalPatternsIndicator.Calculate(conn, trans, table, prod, gran, c, p["Cycle"])},
                        ...
                        {"DynamicSupportResistance", (conn, trans, table, prod, gran, c, p) => DynamicSupportResistanceIndicator.Calculate(conn, trans, table, prod, gran, c, p["Lookback"])},
                        {"FractalDimension", (conn, trans, table, prod, gran, c, p) => FractalDimensionIndicator.Calculate(conn, trans, table, prod, gran, c, p["Window"])},
                        {"HistoricalVolatility", (conn, trans, table, prod, gran, c, p) => HistoricalVolatilityIndicator.Calculate(conn, trans, table, prod, gran, c, p["Period"])},
                        {"HurstExponent", (conn, trans, table, prod, gran, c, p) => HurstExponent.Calculate(conn, trans, table, prod, gran, c, p["MaxLag"])},
                        {"MACDHistogramSlope", (conn, trans, table, prod, gran, c, p) => MACDHistogramSlopeIndicator.Calculate(conn, trans, table, prod, gran, c)},
                        {"MarketEfficiencyRatio", (conn, trans, table, prod, gran, c, p) => MarketEfficiencyRatio.Calculate(conn, trans, table, prod, gran, c, p["Period"])},
                        {"MarketRegime", (conn, trans, table, prod, gran, c, p) => MarketRegimeIndicator.Calculate(conn, trans, table, prod, gran, c, p["Period"])},
                        {"OrderFlowImbalance", (conn, trans, table, prod, gran, c, p) => OrderFlowImbalanceIndicator.Calculate(conn, trans, table, prod, gran, c, p["Period"])},
                        {"OscillatorDivergences", (conn, trans, table, prod, gran, c, p) => OscillatorDivergencesIndicator.Calculate(conn, trans, table, prod, gran, c, p["RSIPeriod"], p["MACDFastPeriod"], p["MACDSlowPeriod"], p["MACDSignalPeriod"])},
                        {"PriceActionClassification", (conn, trans, table, prod, gran, c, p) => PriceActionClassification.Calculate(conn, trans, table, prod, gran, c, p["Period"])},
                        ...
                        {"RelativeVolumeProfile", (conn, trans, table, prod, gran, c, p) => RelativeVolumeProfile.Calculate(conn, trans, table, prod, gran, c, p["LookbackPeriod"])},
                        {"ROCIndicator", (conn, trans, table, prod, gran, c, p) => ROCIndicator.Calculate(conn, trans, table, prod, gran, c)},
                        {"RSIChange", (conn, trans, table, prod, gran, c, p) => RSIChangeIndicator.Calculate(conn, trans, table, prod, gran, c, p["RSIPeriod"])},
                        {"RSIDivergenceStrength", (conn, trans, table, prod, gran, c, p) => RSIDivergenceStrengthIndicator.Calculate(conn, trans, table, prod, gran, c, p["RSIPeriod"])},
